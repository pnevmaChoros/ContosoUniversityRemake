using ContosoUniversityRemake.Models.SchoolViewModels;
using System;
...
using ContosoUniversityRemake.Data;
using ContosoUniversityRemake.Models;

namespace ContosoUniversityRemake.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        [HttpPost/*, ActionName("Edit")*/]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit/*Post*/(int? id, string[] selectedCourses)
        {
            if (id == null)
            {
                return NotFound();
